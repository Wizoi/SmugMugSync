...
namespace SmugMug.Net.Data20
{
    ...
    public class AlbumListResponse
    {
        ...
        public AlbumListResponseContent Response { get; set; } // The main response payload [1, 3, 6]
    ...
    public class AlbumListResponseContent
    {
        ...
        public List<AlbumDetail> AlbumDetail { get; set; } // This would be List<User>, List<Node>, etc. for other endpoints
