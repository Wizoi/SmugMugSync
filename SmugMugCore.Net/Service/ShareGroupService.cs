...
namespace SmugMug.Net.Service
{
    ...
    public class ShareGroupService
    {
        ...
        /// <returns></returns>
        public async Task<bool> AddAlbumToShareGroup(string shareGroupId, string albumId)
        {
            ...
            _ = await _core.QueryWebsite<Data.CouponInfo>("smugmug.sharegroups.albums.add", queryParams, false);
        ...
        /// <param name="albumId">The id for a specific album</param>
        /// <returns></returns>
        public async Task<bool> RemoveAlbumFromShareGroup(string shareGroupId, string albumId)
        {
            // Append the parameters from the request object
            var queryParams = new Core.QueryParameterList();
            queryParams.Add("ShareGroupID", shareGroupId);
            ...
            _ = await _core.QueryWebsite<Data.CouponInfo>("smugmug.sharegroups.albums.remove", queryParams, false);
        ...
        /// <returns></returns>
        public async Task<Data.AlbumDetail[]> GetShareGroupAlbums(string[] fieldList, string shareGroupTag, string password = "")
        {
            // Append the parameters from the request object
            var queryParams = new Core.QueryParameterList();
            ...
            var response = await _core.QueryWebsite<Data.ShareGroup>("smugmug.sharegroups.albums.get", queryParams, true);
        ...
        /// <param name="password">The password for the sharegroup</param>
        /// <returns></returns>
        public async Task<System.Uri> Browse(string shareGroupTag, string password = "")
        {
            ...
            var results = await _core.QueryWebsite<System.Uri>("smugmug.sharegroups.browse", queryParams, false);
            return results[0];
        }
        ...
        /// <returns></returns>
        public async Task<Data.ShareGroup> CreateSharegroup(Data.ShareGroup shareGroup)
        {
            // Append the parameters from teh request object
            var queryParams = new Core.QueryParameterList();
            ShareGroupService.AddShareGroupParameters(queryParams, shareGroup);

            var response = await _core.QueryWebsite<Data.ShareGroup>("smugmug.sharegroups.create", queryParams, false);
        ...
        /// <returns></returns>
        public async Task<bool> UpdateShareGroup(Data.ShareGroup shareGroup)
        {
            // Append the parameters from the request object
            var queryParams = new Core.QueryParameterList();
            ...
            _ = await _core.QueryWebsite<Data.SmugmugError>("smugmug.sharegroups.modify", queryParams, false);
            return true;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<Data.ShareGroup[]> GetShareGroupList(bool includeAlbums = false)
        {
            // Append the parameters from the request object
            var queryParams = new Core.QueryParameterList();
            queryParams.Add("Heavy", includeAlbums);

            var queryResponse = await _core.QueryWebsite<Data.ShareGroup>("smugmug.sharegroups.get", queryParams, true);
