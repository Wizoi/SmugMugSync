...
namespace SmugMug.Net.Data
{
    ...
    /// Album Template
    /// </summary>
    [Serializable(), XmlRoot("AlbumTemplate")]
    public class AlbumTemplate
    {
        /// <summary>
        /// ID for this Album Template
        /// </summary>
        [XmlAttribute("id")]
        public int AlbumTemplateId;

        /// <summary>
        /// Name for this Album Template
        /// </summary>
        [XmlAttribute("Name")]
        ...
        public string? BackprintingForPrints;
        ...
        public PrintmarkInfo? PrintmarkApplied;
        ...
        /// </summary>
        /// <returns></returns>
        public AlbumTemplate Copy()
        {
            var newObject = (AlbumTemplate)MemberwiseClone();
            if (this.Community != null)
                newObject.Community = this.Community.Copy();
            if (this.PrintmarkApplied != null)
                newObject.PrintmarkApplied = (Data.PrintmarkInfo) this.PrintmarkApplied.Copy();
